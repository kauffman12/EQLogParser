...
//                Attribution of a frozen gap - collector, profiler, starved machine - is NOT tested here: that classifier is arithmetic and an
//                interpolated string with nothing WPF in it, so it lives in EQLogParser.Core/src/perf/PerfGap.cs and its wording is asserted in
//                EQLogParser.Test/src/perf/PerfGapTest.cs, where any machine runs it. What is left in this file needs a real dispatcher.
// </file>

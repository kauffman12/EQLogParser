  ...
  public partial class DamageBar : UserControl
  {
    ...
    internal void SetMiniBars(bool miniBars)
    {
      if (miniBars)
      {
        ...
        this.damage.Margin = new System.Windows.Thickness(0, 1, -7, 2);
        this.dps.Margin = new System.Windows.Thickness(0, 1, 3, 2);
      ...
      else
      {
        ...
        this.damage.Margin = new System.Windows.Thickness(0, 0, -7, 1);
        this.dps.Margin = new System.Windows.Thickness(0, 0, 3, 1);

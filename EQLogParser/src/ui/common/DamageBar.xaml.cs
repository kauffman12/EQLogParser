  ...
  public partial class DamageBar : UserControl
  {
    ...
    internal void SetMiniBars(bool miniBars)
    {
      if (miniBars)
      {
        ...
        this.player.Margin = new System.Windows.Thickness(4, 0, 0, 3);
        this.damage.Margin = new System.Windows.Thickness(0, 0, 12, 3);
        this.dps.Margin = new System.Windows.Thickness(0, 0, 6, 3);
        this.time.Margin = new System.Windows.Thickness(0, 0, 2, 3);
      }
      else
      {
        ...
        this.dps.Margin = new System.Windows.Thickness(0, 0, 6, 1);
